...
I'm going to use [Datasette Lite](https://lite.datasette.io/), my build of Datasette running directly in the browser using Python compiled to WebAssembly. More on [how that works here](https://assahbismark.com/2022/May/4/datasette-lite/).
